...
"<CENTER>Answer: MUI, HTMLtext, URLtext, BetterString.  OpenURL is optional. <BR>" \
"<HR>"\
...
"<CENTER>Answer: Ensure you enter the recipient's 'Screen Name' (i.e. username) correctly, it does not currently accept user id numbers.<BR>" \
"<HR>" \
"<CENTER>I like AmiTwitter, how do I donate?<BR>" \
"<CENTER>Answer: Follow the 'Click to Donate!' link to the PayPal website that opens in your favorite web browser<BR>" \
"<HR>" \
"<CENTER>Nothing happens when I click on the links at the very bottom of the main program window?</CENTER><BR>" \
"<CENTER>Answer: Ensure OpenURL is properly installed/configured.<BR>" \
"<HR>" \
"<CENTER>Why is the file size so large?</CENTER><BR>" \
"<CENTER>Answer: Because AmiTwitter relies on numerous libs to work: cURL, SSL, xml2, glib, etc....<BR>" \
"<HR>" \
"<CENTER>Why did you write AmiTwitter?</CENTER><BR>" \
"<CENTER>Answer: To prove it could be done on AmigaOS 3.x!<BR>" \
"<HR>" \
"<CENTER>What is AmiTwitter based on?</CENTER><BR>" \
"<CENTER>Answer: xTwitter by Tsukasa Hamano <BR>" \
"<HR>" \
"<CENTER>Links in the main Tweets window don't work?</CENTER><BR>" \
"<CENTER>Answer: This is not a webbrowser...Also...it is a limitation of the .mcc's currently available for 3.x and useable with gcc (i.e. HTMLtext)<BR>" \
"<HR>" \
